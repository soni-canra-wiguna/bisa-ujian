...
const FormWrapper = ({
  ...
  return (
    <div
      className={cn(
        "col-span-12 lg:col-span-4 h-full flex items-center justify-center gap-4 flex-col bg-background lg:pl-6 lg:pr-12 max-w-lg mx-auto w-full",
        className
      )}
    >
      ...
      {/* this is children is form submit */}
      {children}
